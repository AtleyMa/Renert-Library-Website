...
let books = []; // List of books with this tag applied
...
// Ajax function to apply teh tag to the selected books
$("button.apply").click(function(e)
{
    ...
    $.ajax({
        ...
        success: function(x)
        {
            ...
            $(".applied-book-alert").removeClass("d-none");
            setTimeout( ()=>{
            $(".applied-book-alert").fadeOut( ()=>{
            $(".applied-book-alert").addClass("d-none");
            });
            }, 5000);
        },
        error: function(x)
...
// Ajax function to edit teh tag name of the current tag
function edit(e)
{
...
// Ajax function to edit the tags description
function descEdit(e)
{
    let curr = $(e.currentTarget);
    let row = curr.parent();
        ...
        success: function(x)
            {
                ...
                // Expand apply icon when user hovers over it
...
// Ajax function to undo the edits made to the tag
...
// Ajax function to delete the current tag and redirect to tags
function del(e)
{
    let curr = $(e.currentTarget);
    let row = curr.parent();
...
// Ajax function to undo the deletion of the current tag
...
// Expand edit can icon when hover over it
