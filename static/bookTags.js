// If the user just deleted a book show the respective alert
...
// If the user just undid the deletion of a book then show the respective alert
...
let ogTable = []; // The full table of books
...
// Load the rest of the books with ajax for optimization
$(document).ready( function() {
    $.ajax({
        ...
        success: function(x)
        {
            ...
            for (let i = 0; i < all[0].length; i++)
            {
                if (all[1].includes(all[0][i]['id']))
                {
                    ...
                    <td style="background-color: #ffffcc">
                        <a href="/author/` + all[0][i]['author'] + `" class="text-decoration-none text-info" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Click for books by {{a.author}}"> ` + all[0][i]['author'] + ` </a>
                    </td>
                    <td class="trash-book" data-ren-id="` + all[0][i]['renert_id'] + `" style="background-color: #ffffcc">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash3 text-danger" viewBox="0 0 16 16" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Click to delete book">
                    ...
                    <td class="edit-book" data-edit-ren-id="` + all[0][i]['renert_id'] + `" style="background-color: #ffffcc">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square text-primary" viewBox="0 0 16 16" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Click to edit book">
...
// Ajax function to delete a book from the database
function del(e)
{
...
// Ajax function to undo the deletion of a book from the database
...
// Ajax function to edit a book's title and author in database
function edit(e)
{
    let curr = $(e.currentTarget);
    let row = curr.parent();
...
// ajax function to undo the edits made to a book in teh datatabase
...
// Ajax function to filter the list of books by whether they are tagged/un-tagged
