                ...
                success: function(x)
                    {
                        ...
                        editTD.attr('data-ren-id', deletedBook['renert_id']);
                        ...
                        console.log(deletedBook['renert_id'].replace(deletedBook['id'], String(parseInt(deletedBook['id'])+1)));
                        $("[data-ren-id=" + (deletedBook['renert_id'].replace(deletedBook['id'], String(parseInt(deletedBook['id'])+1))) + "]").parent()[0].before(row[0])
                        trashTD.click(del);
